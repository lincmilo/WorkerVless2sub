...
let mytoken= ['omg'];//快速订阅访问入口, 留空则不启动快速订阅
...
// 设置优选地址api接口
let addressesapi = ['https://youyou-txt.pages.dev/7-26.txt?token=openopen1230',]
...
let DLS = 8;//速度下限
let addressescsv = ['https://youyou-txt.pages.dev/7-26cv.csv?token=openopen1230'];
